...
- 节奏是否恰当
- 是否有语法错误或错别字
- 是否存在明显 AI 感、模板化、口号化或助手式解释腔
- 是否用抽象情绪标签替代动作、感官、停顿、身体反应和环境反馈
- 对话是否像角色在场景中说话，而不是替作者完整说明设定或动机

## AI感文风 Gate

评估正文时必须单独检查 AI 感文风。以下问题重复出现时，应降低文笔评分；严重影响沉浸时必须要求重写：

- 连续使用「这一刻」「他终于明白」「不仅……更是……」「与此同时……也意味着……」等总结式套话。
- 段落开头、转折、结尾过度工整，像生成摘要而不是现场叙事。
