...
DEFAULT_AGENT_OUTPUT_CONTRACTS: List[AgentOutputContract] = [
    ...
    AgentOutputContract(
        contract_id="master_plotter.scene_plan.workflow_output",
        surface_name="master_scene_plan_workflow_output",
        description="总编剧将章节大纲编译为 Writer/Evaluator 可消费的场景计划契约。",
        agent_type=AgentType.MASTER_PLOTTER,
        scene=OutputContractScene.WORKFLOW_RUNTIME,
        consumer=OutputContractConsumer.DOWNSTREAM_NODE,
        mode=OutputContractMode.STRICT,
        schema_name="master_plotter.scene_plan.workflow_output",
        structured_fields=["plan_id", "scene_plan", "writer_brief", "evaluator_checklist", "ending_hook_contract", "resource_requirements"],
        schema_ref="app.models.agent_output_schemas.MasterScenePlanSchema",
        retry_policy=OutputContractRetryPolicy.RETRY_THEN_REPAIR,
    ),
    AgentOutputContract(
        contract_id="master_plotter.revision_directive.workflow_output",
        surface_name="master_revision_directive_workflow_output",
        description="质量门失败后总编剧输出的结构化修订导演指令。",
        agent_type=AgentType.MASTER_PLOTTER,
        scene=OutputContractScene.WORKFLOW_RUNTIME,
        consumer=OutputContractConsumer.DOWNSTREAM_NODE,
        mode=OutputContractMode.STRICT,
        schema_name="master_plotter.revision_directive.workflow_output",
        structured_fields=["revision_id", "rewrite_strategy", "issues", "writer_revision_brief", "evaluator_focus", "acceptance_criteria"],
        schema_ref="app.models.agent_output_schemas.MasterRevisionDirectiveSchema",
        retry_policy=OutputContractRetryPolicy.RETRY_THEN_REPAIR,
    ),
    AgentOutputContract(
    ...
    AgentOutputContract(
        contract_id="evaluator.chapter_quality_gate.workflow_output",
        surface_name="evaluator_chapter_quality_gate_workflow_output",
        description="Evaluator 在章节工作流质量门中输出的结构化评估结果。",
        agent_type=AgentType.EVALUATOR,
        scene=OutputContractScene.WORKFLOW_RUNTIME,
        consumer=OutputContractConsumer.DOWNSTREAM_NODE,
        mode=OutputContractMode.STRICT,
        schema_name="evaluator.chapter_quality_gate.workflow_output",
        structured_fields=[
            "quality_passed",
            "score",
            "issues",
            ...
            "failed_scene_beat_ids",
        ],
        schema_ref="app.models.agent_output_schemas.EvaluatorChapterEndSchema",
        retry_policy=OutputContractRetryPolicy.RETRY_THEN_REPAIR,
    ),
    AgentOutputContract(
