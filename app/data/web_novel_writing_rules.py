...
WEB_NOVEL_WRITING_RULES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "examples": [
            ...
            "【AI感/大纲扩写】像是有人把恒星塞进了他的颅腔。属于另一个存在的记忆碎片呼啸着涌入——古老的代码、失落的力量、还有某个存在留下的警告符号。\n【自然/大纲转场景】林墨先听见一声蜂鸣。不是耳机，耳机三天前就坏了。屏幕上的星图抖了一下，三颗本该熄灭的光点重新亮起。他伸手去关终端，指尖却先一步按下确认键。警告框弹出时，只剩一个残缺字符。"
        ],
        "counter_examples": [
            "空气中弥漫着一种无法言说的紧张感，仿佛所有人都意识到，真正的危机才刚刚开始。",
            "他知道，自己必须做出选择。这不仅关系到他的未来，也关系到整个世界的命运。",
            "他最后望了一眼远处的城市核心区：明天还有活要干。（第一章结尾只收束，没有具体异常、代价、误判或未解问题）"
        ]
    },
    {
